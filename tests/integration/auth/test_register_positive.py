...
class TestUserRegisterPositive:
    ...
    def test_full_auth_flow(self, user_factory, setup_teardown_user, api_client):
        """
        ...
        with allure.step("步骤1：发送合法注册请求"):
            resp = api_client.post("/api/v2/user/register", json=valid_user)
        ...
        with allure.step("步骤2：发送合法登录请求"):
            ...
            resp_login = api_client.post("/api/v2/user/login", json=login_payload)
